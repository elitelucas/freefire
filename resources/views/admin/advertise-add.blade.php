...
@section('title') Advertise-Add @endsection
@section('css')
<!-- DataTables -->
...
@slot('title') Advertise Add @endslot
@slot('li_1') @endslot
@endcomponent
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="{{ url('admin/advertise/confirmAdd') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row mb-2">
                        <div class="col-4">
