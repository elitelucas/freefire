                    ...
                    <ul class="list-group" data-simplebar style="max-height: 390px;">
                            ...
                            <div class="media">
                                <div class="avatar-xs mr-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{asset('/assets/images/companies/img-1.png')}}" alt="" height="18">
                                    </span>
                                </div>
                        ...
                        <li class="list-group-item">
                            <div class="media">
                                <div class="avatar-xs mr-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{asset('/assets/images/companies/img-2.png')}}" alt="" height="18">
                                    </span>
                                </div>
                                <div class="media-body">
                        ...
                        <li class="list-group-item">
                            <div class="media">
                                <div class="avatar-xs mr-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{asset('/assets/images/companies/img-3.png')}}" alt="" height="18">
                                    </span>
                                </div>
                                <div class="media-body">
