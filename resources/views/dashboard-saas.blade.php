    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            <div class="row">
                ...
                @component('common-components.saas-widget')
                    @slot('icon') bx bx-copy-alt @endslot
                    @slot('title') Orders @endslot
                    @slot('price') 1,452 @endslot
                    @slot('bClass') badge badge-soft-success font-size-12 @endslot
                    @slot('bValue') + 0.2% @endslot
                @endcomponent

                @component('common-components.saas-widget')
                    @slot('icon') bx bx-archive-in @endslot
                    @slot('title') Revenue @endslot
                    @slot('price') $ 28,452 @endslot
                    @slot('bClass') badge badge-soft-success font-size-12 @endslot
                    @slot('bValue') + 0.2% @endslot
                @endcomponent

                @component('common-components.saas-widget')
                    @slot('icon') bx bx-purchase-tag-alt @endslot
                    @slot('title') Average Price @endslot
                    @slot('price') $ 16.2 @endslot
                    @slot('bClass') badge badge-soft-warning font-size-12 @endslot
                    @slot('bValue') + 0% @endslot
                @endcomponent
