    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form method="post" action="{{ url('/admin/top-up/confirmAdd') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="row mb-5">
                        <div class="col-4">
                            <span>image</span>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-8">
                            <input class="w-50" type="number" name="diamond" required>  
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <input class="w-50" type="number" name="first_bonus" required>  
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-4">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-8">
                            <input class="w-50" type="number" name="actual_amount"  required>  
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <input class="w-50" type="number" name="offer_amount" required>  
                        </div>
                    </div>
