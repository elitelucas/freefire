                ...
                <tbody>
                        ...
                        <td>
                            <div class="team">
                                <div class="custom-control custom-switch custom-switch-lg mb-3" dir="ltr">
                                    <input type="checkbox" name="chat_switch" class="custom-control-input" id="chat_switch" <?php if($site_chat->chat_enable==1) echo 'checked' ?> >
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="team">
                                <div class="custom-control custom-switch custom-switch-lg mb-3" dir="ltr">
                                    <input type="checkbox" name="site_switch" class="custom-control-input" id="site_switch" <?php if($site_chat->site_online==1) echo 'checked' ?>>
                                    <label class="custom-control-label" for="site_switch"></label>
                                </div>
                            </div>
                            <input type="text" id="chat_site_id" name="id" value="{{$site_chat->id}}" hidden>
                        </td>
                    </tr>
                </tbody>
            </table>
